		...
		if($valid)
		{
			...
			/*
				...
				*/
				...
				unset($_POST['phone-req-num']);
				unset($_POST['contactName-req-alpha']);
				unset($_POST['postcode-req-num']);
				unset($_POST['State-req']);
				unset($_POST['contactName-req-alpha']);
				unset($_POST['Email-req-email']);
				unset($_POST['phone-req-num'];
				unset($_POST['type-req']);
				unset($_POST['quantity-req-num']);
				unset($_POST['readydate-req'];
				*/
